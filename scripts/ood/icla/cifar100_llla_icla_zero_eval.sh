...
do
    ...
    --postprocessor.postprocessor_args.llla_type 'icla_zero' \
    --postprocessor.postprocessor_args.checkpoint_path "pretrained_weights/icla_c100/$(expr $SEED + 1)/best.ckpt" \
